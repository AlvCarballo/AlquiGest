  ...
  <aside id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div class="nav-item active" tabindex="0" role="button" data-page="dashboard" onclick="navigate('dashboard')">
      ...
      <div class="nav-group" id="nav-group-maestros">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-propietarios" data-page="propietarios" onclick="navigate('propietarios')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-fincas" data-page="fincas" onclick="navigate('fincas')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-inmuebles" data-page="inmuebles" onclick="navigate('inmuebles')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-inquilinos" data-page="inquilinos" onclick="navigate('inquilinos')">
      ...
      <div class="nav-group" id="nav-group-alquileres">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-contratos" data-page="contratos" onclick="navigate('contratos')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-recibos" data-page="recibos" onclick="navigate('recibos')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-facturas" data-page="facturas" onclick="navigate('facturas')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-generar" data-page="generar" onclick="navigate('generar')">
      ...
      <div class="nav-group" id="nav-group-informes">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-informes" data-page="informes" onclick="navigate('informes')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-calendario" data-page="calendario" onclick="navigate('calendario')">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
          Calendario Cobros
        </div>
        <div class="nav-item" tabindex="0" role="button" id="nav-morosidad" data-page="morosidad" onclick="navigate('morosidad')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-actividad" data-page="actividad" onclick="navigate('actividad')">
      ...
      <div class="nav-group" id="nav-group-config">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-empresa" data-page="empresa" onclick="navigate('empresa')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-configuracion" data-page="configuracion" onclick="navigate('configuracion')">
        ...
        <div class="nav-item" tabindex="0" role="button" id="nav-verifactu" data-page="verifactu" onclick="navigate('verifactu')">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          VERI*FACTU
        </div>
        <div class="nav-item" tabindex="0" role="button" id="nav-plantillas" data-page="plantillas" onclick="navigate('plantillas')">
